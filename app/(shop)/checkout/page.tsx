...
export default function CheckoutPage() {
  ...
  if (isSuccess) {
    return (
      <div className="flex-grow w-full max-w-[1280px] mx-auto px-6 md:px-12 lg:px-40 py-24 flex flex-col items-center justify-center text-center">
        ...
        <h1 className="text-3xl font-extrabold text-[#181211] dark:text-white tracking-tight mb-4">Order Confirmed!</h1>
  ...
  return (
    <div className="flex-grow flex justify-center w-full px-4 py-8 sm:px-6 lg:px-8 bg-background-light dark:bg-background-dark">
      <div className="flex flex-col lg:flex-row max-w-7xl w-full gap-12">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-[#181211] dark:text-white mb-8">Shipping Details</h1>
          
          <form onSubmit={handleSubmit} className="flex-1 flex flex-col">
            {/* Contact Info Section */}
            <div className="mb-8">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-semibold text-[#181211] dark:text-slate-100">Contact Information</h2>
            ...
            <div className="mb-8">
              <h2 className="text-xl font-semibold text-[#181211] dark:text-slate-100 mb-4">Shipping Address</h2>
              <div className="grid grid-cols-1 gap-y-4 gap-x-4 sm:grid-cols-2">
                <div className="sm:col-span-1">
                  <label className="block text-sm font-medium text-[#181211] dark:text-slate-200 mb-1" htmlFor="first-name">First name</label>
                ...
                <div className="sm:col-span-1">
                  <label className="block text-sm font-medium text-[#181211] dark:text-slate-200 mb-1" htmlFor="last-name">Last name</label>
                ...
                <div className="sm:col-span-2">
                  <label className="block text-sm font-medium text-[#181211] dark:text-slate-200 mb-1" htmlFor="address">Address</label>
                ...
                <div className="sm:col-span-2">
                  <label className="block text-sm font-medium text-[#181211] dark:text-slate-200 mb-1" htmlFor="apartment">Apartment, suite, etc. (optional)</label>
                ...
                <div className="sm:col-span-1">
                  <label className="block text-sm font-medium text-[#181211] dark:text-slate-200 mb-1" htmlFor="city">City</label>
                ...
                <div className="sm:col-span-1">
                  <label className="block text-sm font-medium text-[#181211] dark:text-slate-200 mb-1" htmlFor="country">Country/Region</label>
                ...
                <div className="sm:col-span-1">
                  <label className="block text-sm font-medium text-[#181211] dark:text-slate-200 mb-1" htmlFor="state">State</label>
                ...
                <div className="sm:col-span-1">
                  <label className="block text-sm font-medium text-[#181211] dark:text-slate-200 mb-1" htmlFor="zip">ZIP code</label>
            ...
            {/* Shipping Method */}
            <div className="mb-10">
              <h2 className="text-xl font-semibold text-[#181211] dark:text-slate-100 mb-4">Shipping Method</h2>
              <div className="rounded-lg border border-[#e6dddb] dark:border-[#3a2522] overflow-hidden">
                <label className="relative flex cursor-pointer p-4 border-b border-[#e6dddb] dark:border-[#3a2522] hover:bg-[#f8f6f5] dark:hover:bg-[#3a2522] transition-colors">
                  ...
                  <span className="ml-3 flex flex-col">
                    <span className="block text-sm font-medium text-[#181211] dark:text-white">Standard Shipping</span>
                    <span className="block text-sm text-[#8a6760] dark:text-slate-400">4-5 Business Days</span>
                  </span>
                  <span className="ml-auto font-medium text-[#181211] dark:text-white">Free</span>
                </label>
                <label className="relative flex cursor-pointer p-4 hover:bg-[#f8f6f5] dark:hover:bg-[#3a2522] transition-colors">
                  ...
                  <span className="ml-3 flex flex-col">
                    <span className="block text-sm font-medium text-[#181211] dark:text-white">Express Shipping</span>
                    <span className="block text-sm text-[#8a6760] dark:text-slate-400">1-2 Business Days</span>
                  </span>
                  <span className="ml-auto font-medium text-[#181211] dark:text-white">$15.00</span>
                </label>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between mt-auto pt-6 border-t border-[#e6dddb] dark:border-[#3a2522]">
              <Link className="flex items-center gap-2 text-sm font-medium text-[#8a6760] hover:text-[#181211] dark:text-slate-400 dark:hover:text-white transition-colors" href="/cart">
        ...
        <div className="w-full lg:w-[380px] flex-shrink-0">
          <div className="sticky top-8 rounded-xl bg-white dark:bg-[#1a0f0d] border border-[#e6dddb] dark:border-[#3a2522] shadow-sm p-6">
            <h2 className="text-xl font-bold text-[#181211] dark:text-white mb-6">Order Summary</h2>
            
            {/* Items List */}
            <div className="space-y-6 mb-6">
              {cart.map((item) => (
                <div key={item.id} className="flex items-start gap-4">
                  <div className="relative h-20 w-20 flex-shrink-0 rounded-lg border border-[#e6dddb] bg-[#f8f6f5] dark:border-[#3a2522] dark:bg-[#2c1c19] overflow-hidden">
                  ...
                  <div className="flex flex-1 flex-col">
                    <span className="text-sm font-medium text-[#181211] dark:text-white line-clamp-2 leading-tight">{item.name}</span>
                    <span className="text-xs text-[#8a6760] dark:text-slate-400 mt-1">Category: {item.category}</span>
                  </div>
                  <span className="text-sm font-medium text-[#181211] dark:text-white">${(item.price * item.quantity).toFixed(2)}</span>
                </div>
              ))}
            </div>
            ...
            <div className="flex gap-2 mb-6 pt-6 border-t border-[#e6dddb] dark:border-[#3a2522]">
              ...
              <button className="bg-[#e6dddb] hover:bg-[#d6c7c4] dark:bg-[#3a2522] dark:hover:bg-[#4a3532] text-[#181211] dark:text-white rounded-lg px-4 py-2 text-sm font-bold transition-colors">Apply</button>
            </div>
            ...
            <div className="space-y-3 border-t border-[#e6dddb] dark:border-[#3a2522] pt-6">
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-medium text-[#181211] dark:text-white">${cartTotal.toFixed(2)}</span>
              </div>
              <div className="flex items-center justify-between text-sm">
                <span className="text-[#5c4540] dark:text-slate-400">Shipping</span>
                <span className="text-sm font-medium text-[#181211] dark:text-white">{shipping === 0 ? "Free" : `$${shipping.toFixed(2)}`}</span>
              </div>
              <div className="flex items-center justify-between text-sm">
                <span className="text-[#5c4540] dark:text-slate-400">Taxes</span>
                <span className="font-medium text-[#181211] dark:text-white">${tax.toFixed(2)}</span>
              </div>
            </div>
            
            {/* Total */}
            <div className="flex items-center justify-between border-t border-[#e6dddb] dark:border-[#3a2522] pt-6 mt-6">
              <span className="text-base font-semibold text-[#181211] dark:text-white">Total</span>
              <div className="flex items-baseline gap-1">
                <span className="text-xs text-[#8a6760] dark:text-slate-400">USD</span>
                <span className="text-2xl font-bold text-[#181211] dark:text-white">${finalTotal.toFixed(2)}</span>
              </div>
            </div>
